...
const routes = [
  ...
  },
  {
    ...
    name: "order.view",
    component: () =>
      import(/* webpackChunkName: "order-view" */ "../views/OrderView.vue"),
    props: true,
  },
  {
    path: "/account",
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "usage" */ "../views/UsageAgreementsView.vue"
      ),
  },
  {
    path: "/signup",
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "forcustomers" */ "../views/ForCustomersView.vue"
      ),
  },
  {
    path: "/blog",
  ...
  },
  {
    ...
    name: "bonus",
    component: () =>
      import(/* webpackChunkName: "bonus" */ "../views/BonusView.vue"),
  },
  {
    path: "/support",
    name: "support",
  ...
  },
  {
    ...
    name: "patent",
    component: () =>
      import(/* webpackChunkName: "patent" */ "../views/PatentView.vue"),
  },
  {
    path: "/termsofuse",
    name: "termsofuse",
    component: () =>
      import(
        /* webpackChunkName: "termsofuse" */ "../views/TermsOfUseView.vue"
      ),
  },
  {
    path: "/:pathMatch(.*)*",
